...
public abstract class ValuesEnumRelationBuilder<T extends Enum<? extends Enum<?>>> extends AbstractBuilder {
    ...
    public ValuesEnumRelationBuilder(String value1Name, Function<BuiltCotation, Optional<Double>> value1Transfomer, String value2Name, Function<BuiltCotation, Optional<Double>> value2Transfomer) {
    ...
    public ValuesEnumRelationBuilder(String value1Name, Function<BuiltCotation, Optional<Double>> value1Transfomer, Double constantValue) {
        this(value1Name, value1Transfomer, constantValue.toString(), constantValue);
    }

    public ValuesEnumRelationBuilder(String value1Name, Function<BuiltCotation, Optional<Double>> value1Transfomer, String value2Name, Double constantValue) {
