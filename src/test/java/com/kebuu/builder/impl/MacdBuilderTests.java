...
public class MacdBuilderTests extends AbstractBuilderTests<MacdBuilder> {
    ...
    public void testBuildCotations() {
        ...
        Assertions.assertThat(getRoundedValue(builtCotations, 4).get()).isEqualTo(0.166667);
        Assertions.assertThat(getRoundedValue(builtCotations, 9).get()).isEqualTo(-0.296832);
    }
