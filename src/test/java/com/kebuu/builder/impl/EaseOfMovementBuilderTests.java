...
public class EaseOfMovementBuilderTests extends AbstractBuilderTests<EaseOfMovementBuilder> {
    ...
    public void testBuildCotations() {
        ...
        Assertions.assertThat(builtCotations.getValue(2, builder.attribute()).get()).isEqualTo(NumberUtils.DOUBLE_ZERO);
        Assertions.assertThat(builtCotations.getValue(3, builder.attribute()).get()).isEqualTo(NumberUtils.DOUBLE_ZERO);
        Assertions.assertThat(builtCotations.getValue(4, builder.attribute()).get()).isEqualTo(1000000.0 * (((2.0 + 1.0) - (1.0 + 1.0)) / 2.0) * (2.0 - 1.0) / 30.0);
        Assertions.assertThat(builtCotations.getValue(5, builder.attribute()).get()).isEqualTo(1000000.0 * (((3.0 + 1.0) - (2.0 + 1.0)) / 2.0) * (3.0 - 1.0) / 40.0);
    }
    ...
    public void testBuildCotations_withRange_1() {
        ...
        Assertions.assertThat(builtCotations.getValue(5, builder.attribute()).get()).isEqualTo(20370.37037037037);
    }
